        ...
        for action in [
            ...
            if hitsWall is False:
                ...
                for i in range(len(self.corners)):
                    visited.append(((nextx, nexty) == self.corners[i])
                                   or state[i + 1])
                successors.append((((nextx, nexty), visited[0], visited[1],
                                    visited[2], visited[3]), action, 1))
    ...
    for i in range(len(corners)):
        if state[i + 1] is False:
            heuristic_value = max(heuristic_value,
                                  util.manhattanDistance(state[0], corners[i]))
